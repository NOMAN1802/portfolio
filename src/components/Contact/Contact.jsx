    ...
    <div id="contact">
      <Container>
        <div>
          ...
          >
            <h2 style={{fontFamily: 'cursive', fontSize: '25px'}} className="text-slate-400 text-3xl md:text-5xl font-bold mb-5">
              Contact With Me
            </h2>
            <p style={{fontFamily: 'cursive', fontSize: '18px'}} className="text-slate-400">
